<div class="d-flex flex-column flex-center w-100 min-h-350px min-h-lg-500px px-9">
    ...
    <div class="text-center mb-5 mb-lg-10 py-10 py-lg-20">
        <!--begin::Title-->
        <h1 class="text-white lh-base fw-bolder fs-2x fs-lg-3x mb-15">Take Control of Your Finances, One
            Expense at a Time
            <br />with
            <span
                style="background: linear-gradient(to right, #12CE5D 0%, #FFD80C 100%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;">
                <span id="kt_landing_hero_text">Smart Tracking, Smarter Spending</span>
            </span>
        </h1>
        <!--end::Title-->
        <!--begin::Action-->
        <a href="/register" class="btn btn-primary">Try Expense Tracker</a>
        <!--end::Action-->
    </div>
    <!--end::Heading-->
    <!--begin::Clients-->
