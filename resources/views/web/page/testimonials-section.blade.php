<div class="mt-20 mb-n20 position-relative z-index-2">
    ...
    <div class="container">
        ...
        <div class="d-flex flex-stack flex-wrap flex-md-nowrap card-rounded shadow p-8 p-lg-12 mb-n5 mb-lg-n13"
            ...
            <div class="my-2 me-5">
                <!--begin::Title-->
                <div class="fs-1 fs-lg-2qx fw-bolder text-white mb-2">Start Tracking Your Expenses Today,
                    <span class="fw-normal">Simplify Your Financial Life!</span>
                </div>
                <!--end::Title-->
                <!--begin::Description-->
                <div class="fs-6 fs-lg-5 text-white fw-bold opacity-75">Join Over 100,000 Savvy Savers to Stay
                    on Top of Your Budget</div>
                <!--end::Description-->
            </div>
            <!--end::Content-->
            <!--begin::Link-->
            <a href="/register" class="btn btn-lg btn-outline border-2 btn-outline-white flex-shrink-0 my-2">Try It</a>
            <!--end::Link-->
        </div>
        <!--end::Highlight-->
    </div>
